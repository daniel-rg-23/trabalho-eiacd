...
class Game:
    ...
    def __init__(self):
        ...
        self.push_state()
        self.game2 = Game2()
        self.game2 = False  # Attribute to synchronize between levels
            ...
            for event in pygame.event.get():
                if event.type == pygame.QUIT:
                    ...
                    if self.home.collidepoint(mouse_pos):
                       ...
                       self.reset_level()
                    elif self.next.collidepoint(mouse_pos):
                       self.load_level2()  # Load the next level
        ...
        for event in pygame.event.get():
            if event.type == pygame.QUIT:
                ...
                if self.resart.collidepoint(mouse_pos):
                    ...
                    self.apply_solution(self.initial_state)
                # Call the pop_state method to restore the previous game state
