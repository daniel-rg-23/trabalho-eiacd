...
class Game3:
    QUIET_TILES = [(0, 0), (0, 3), (1, 2), (1, 3), (3,3)]
    MOVABLE_TILES = [(1, 0), (2, 1)]
    MATCH_TILES = [(0, 1), (2, 2)]
    ...
    def __init__(self):
        ...
        self.tiles_that_are_quiet = Game3.QUIET_TILES
        self.tiles_that_move = Game3.MOVABLE_TILES
        self.tiles_to_be_matched = Game3.MATCH_TILES
