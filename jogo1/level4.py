...
class Game4:
    QUIET_TILES = [(0, 0), (0, 1), (1, 3), (2, 2), (2,3), (3,0)]
    MOVABLE_TILES = [(0, 3), (1, 2)]
    MATCH_TILES = [(0, 2), (3,1)]
    ...
    def __init__(self):
        ...
        self.tiles_that_are_quiet = Game4.QUIET_TILES
        self.tiles_that_move = Game4.MOVABLE_TILES
        self.tiles_to_be_matched = Game4.MATCH_TILES
