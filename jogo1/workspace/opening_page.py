...
class OpeningPage:
    def __init__(self, screen_width, screen_height):
        ...
        self.font_small = pygame.font.SysFont("Calibri", 65, bold=True)  # Font for the bottom buttons
        ...
        self.start_normal = pygame.Rect(255, 766, 285, 140)  # Define the start button rectangle
        self.algorit = pygame.Rect(705, 10, 80, 80)  # Define the start button rectangle
        self.start_normal_text = self.font_small.render("Play", True, WHITE)
