...
class Game2:
    QUIET_TILES = [(0, 1), (0, 2), (0, 3), (2, 2), (3,3)]
    MOVABLE_TILES = [(0, 0), (3, 0)]
    MATCH_TILES = [(3,2), (2, 3)]
    ...
    def __init__(self):
        ...
        self.tiles_that_are_quiet = Game2.QUIET_TILES
        self.tiles_that_move = Game2.MOVABLE_TILES
        self.tiles_to_be_matched = Game2.MATCH_TILES
    ...
    def goal_state_func(self, state):
        return state[3][2] == 2 and state[2][3] == 2
